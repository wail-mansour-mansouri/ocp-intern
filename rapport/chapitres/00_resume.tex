...
Sur le scénario de référence, le modèle atteint le statut optimal en \SI{0,06}{\second} et
...
de sensibilité en établit la cause unique et le remède chiffré : réduire de quatre à un le
nombre d'échelons affectés à la cocristallisation sur la ligne 14EXT résorbe intégralement
les deux violations, sans investissement et sans dégrader le service rendu.
